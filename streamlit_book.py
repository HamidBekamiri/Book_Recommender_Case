...
#cols = st.columns((2))
selectbox_title = st[0].selectbox('Please choose the book title', col_one_list_tit, index=0)
selectbox_author = st[1].selectbox('Please choose the author', col_one_list_auth, index=0)
