...
#cols = st.columns((2))
selectbox_title = st.selectbox('Please choose the book title', col_one_list_tit, index=0)
selectbox_author = st.selectbox('Please choose the author', col_one_list_auth, index=0)
